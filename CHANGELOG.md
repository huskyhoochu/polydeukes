...
* **polydeukes:** refuse a config whose declaration cannot compile (ISSUE-61) ([#133](https://github.com/huskyhoochu/polydeukes/issues/133)) ([6f6abc8](https://github.com/huskyhoochu/polydeukes/commit/6f6abc8940762543873c3c6a379789df07ac0c75))
...
* **polydeukes:** disciplines live in the list of the surface that observes them (SURFACE-05) ([#110](https://github.com/huskyhoochu/polydeukes/issues/110))
* **polydeukes:** this repository is judged by the install units it ships (SURFACE-04) ([#108](https://github.com/huskyhoochu/polydeukes/issues/108))
* **adapter-grok:** add Grok session-surface install unit (SURFACE-03c) ([#107](https://github.com/huskyhoochu/polydeukes/issues/107))
* **adapter-claude-code:** install unit — pdks-claude-code init and runHook spawn (SURFACE-03b) ([#106](https://github.com/huskyhoochu/polydeukes/issues/106))
* **polydeukes:** fold covenant into the umbrella, drop the barrel, static judge (SURFACE-02) ([#104](https://github.com/huskyhoochu/polydeukes/issues/104))

### Features

* **adapter-claude-code:** install unit — pdks-claude-code init and runHook spawn (SURFACE-03b) ([#106](https://github.com/huskyhoochu/polydeukes/issues/106)) ([6e6e897](https://github.com/huskyhoochu/polydeukes/commit/6e6e89708f0f08e65fde13056151d249722398c7))
* **adapter-grok:** add Grok session-surface install unit (SURFACE-03c) ([#107](https://github.com/huskyhoochu/polydeukes/issues/107)) ([4d0370a](https://github.com/huskyhoochu/polydeukes/commit/4d0370aaa6b3354ed4f23634f24c50a81ad5efac))
* **config:** a PRD edit needs its writing method read first ([a52605d](https://github.com/huskyhoochu/polydeukes/commit/a52605d01b2f0f7dc3b19083fedc47b31347c348))
* **polydeukes:** a banned token quoted in stdin data is not a command line (COVENANT-22) ([#109](https://github.com/huskyhoochu/polydeukes/issues/109)) ([a1410a5](https://github.com/huskyhoochu/polydeukes/commit/a1410a5e9ba4cb345c51a1d630bbb4d05c827bff))
* **polydeukes:** disciplines live in the list of the surface that observes them (SURFACE-05) ([#110](https://github.com/huskyhoochu/polydeukes/issues/110)) ([7d3438e](https://github.com/huskyhoochu/polydeukes/commit/7d3438e6773dc452422fb9f862c496b68716c737))
* **polydeukes:** fold covenant into the umbrella, drop the barrel, static judge (SURFACE-02) ([#104](https://github.com/huskyhoochu/polydeukes/issues/104)) ([4188ca3](https://github.com/huskyhoochu/polydeukes/commit/4188ca369a029a9bb0af374754152b9efa858bf1))
* **polydeukes:** IR session evidence contract — tools and session keys, CLI session assembly (SURFACE-03a) ([#105](https://github.com/huskyhoochu/polydeukes/issues/105)) ([7022ff3](https://github.com/huskyhoochu/polydeukes/commit/7022ff31ae09de85c20fb8647a613a432bb2be23))
* **polydeukes:** stdin IR and --diff input contract, adapter-git deleted (SURFACE-01) ([#102](https://github.com/huskyhoochu/polydeukes/issues/102)) ([0fd5fdf](https://github.com/huskyhoochu/polydeukes/commit/0fd5fdfc024c99f0bcc4bce975da43a2a7eed7b7))
* **polydeukes:** this repository is judged by the install units it ships (SURFACE-04) ([#108](https://github.com/huskyhoochu/polydeukes/issues/108)) ([012e92c](https://github.com/huskyhoochu/polydeukes/commit/012e92c15a405ebf5b04c4b3c45b46bddcbfb9f1))
