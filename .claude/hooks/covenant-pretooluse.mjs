 ...
 * `runSessionHook`, so this repository consumes the same entry point a consumer
 ...
 *
 * fail-closed: `runSessionHook` translates every failure it can reach into exit 2
