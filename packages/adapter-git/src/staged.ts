/**
 * staged — the pure translation core: staged changes → the covenant input IR.
 *
 * No I/O, no process spawning. The tool-name constants are adapter-owned values: the core
 * type stays literal-free, and this boundary is where git's vocabulary is translated away
