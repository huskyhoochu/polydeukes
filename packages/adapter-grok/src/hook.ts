 ...
 * — the translated payload, this host's tool roster, the file-change evidence — and hands
 * it to the umbrella's bin on stdin. Every verdict, and every row, is the child's.
 *
 ...
 *
 * Throws {@link PreSpawnFailure} naming the step that failed. The steps fail for
