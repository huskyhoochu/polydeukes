...
**Pre-alpha.** The first units have landed: the covenant protocol (stdin-JSON / exit-code semantics), the ROI telemetry collector (`gain`), and the `defineConfig()` loader.
