...
import { type TokenizeResult, tokenizeCommandLine } from '../../src/covenant/bash-line.ts';
import { type CovenantRegistration, matchRegistrations } from '../../src/covenant/dispatch.ts';
import { deriveShellChanges } from '../../src/covenant/shell-evidence.ts';
import {
  DEFAULT_READ_ONLY_COMMANDS,
  judgeShellModification,
  type ShellModificationSpec,
} from '../../src/covenant/shell-mod.ts';
import {
  judgeTranscriptModification,
  type TranscriptModificationSpec,
} from '../../src/covenant/transcript-mod.ts';
