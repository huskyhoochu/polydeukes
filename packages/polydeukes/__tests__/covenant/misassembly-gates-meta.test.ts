...
import type { RunCovenantSpec } from '../../src/covenant/run-covenant.ts';
import { runCovenant } from '../../src/covenant/run-covenant.ts';
import { selfModRegistration } from '../../src/covenant/self-mod.ts';
import { shellModRegistration } from '../../src/covenant/shell-mod.ts';
import { transcriptModRegistration } from '../../src/covenant/transcript-mod.ts';
